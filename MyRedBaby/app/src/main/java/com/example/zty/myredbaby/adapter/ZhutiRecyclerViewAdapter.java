...
public class ZhutiRecyclerViewAdapter extends RecyclerView.Adapter<ZhutiRecyclerViewAdapter.MyViewHolder> {
    private final Context context;
    private final LayoutInflater inflater;
    private final ArrayList<Bean.Tag> hwList;

    public ZhutiRecyclerViewAdapter(Context context, ArrayList<Bean.Tag> hwList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ImageLoader.getInstance().displayImage("http://image1.suning.cn" + hwList.get(position).picUrl, holder.list_img2, ImageLoaderUtils.initOptions());
